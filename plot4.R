...
#First Plot
plot(consumptionDateTime,newdat$`global-active-power`,type = "l",xlab = "",ylab = "Global Active Power")

#Second Plot
plot(consumptionDateTime,newdat$voltage,type = "l", xlab = "datetime", ylab = "Voltage")
...
#Fourth Plot
plot(consumptionDateTime,newdat$`global-reactive-power`, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()